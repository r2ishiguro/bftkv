  ...
  \begin{tikzpicture}
    \matrix (m) [matrix of math nodes, nodes in empty cells, row
      ...
      \begin{minipage} {5cm} \begin{multline*}
          t_{1j}, t_2, t_{3j}, t_4, t_5 \xleftarrow{\mathcal{R}}
          \mathbb{Z}_q \\ v_{1ij} = c_{ij}^{t_{1j}}, \; v_{2i} =
          u^{t_2}, \; v_{3ij} = u^{-t_3j}, \\
    ...
    \draw [->] (m-3-1) -- (m-3-2) node [midway, above] {$v_{1ij}, v_{2i}, v_{3ij}, v_{4i}, v_{5i}$};
